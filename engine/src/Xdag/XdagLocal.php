...
class XdagLocal extends Xdag
{
	...
	protected function getCommandData($cmd)
	{
		...
		if ($cmd[0] == 'stats')
            ...
            hosts: 456 of 456
           blocks: 58027510 of 58030534
      main blocks: 189734 of 189734
    orphan blocks: 133
 wait sync blocks: 260
 chain difficulty: 630fcc7af946716ccb8c40865da of 630fcc7af946716ccb8c40865da
      XDAG supply: 194287616.000000000 of 194287616.000000000
4 hr hashrate MHs: 2357987.48 of 75100856.87';
...
QHul3aEvYN8KHkArCW7xOw1i5uLLGRzN   2018-06-14 19:34:23.999   Main' . $remark_2;
		...
		if (!$this->versionGreaterThan('0.2.4') && $cmd[0] == 'miners')
			return 'List of miners:
 NN  Address for payment to            Status   IP and port            in/out bytes      nopaid shares
------------------------------------------------------------------------------------------------------
 -1. Ryks3ajvGukqndEZpqvuFp9frbl4b+r0  fee      -                      -                 0.000000
  0. 0Iq15k/FdqPczGHWWXzAXQAyWtJU4Vgv  active   -                      -                 23130.174388
 C1. -                                 -        111.111.111.11:51111   289344/189376     0.000014
  1. Rkqm33lpfmq3/kY6aBeqGqFmneq/+/fq  active   -                      -                 272470.152109
 C1. -                                 -        66.111.222.223:61111   570496/902080     272470.152109
------------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------------------------------------------------
 -1. 4sQ1JEZ5i7r1/voTfUFs7esRxm9u2zz8  fee      -                      -                 0.000000       -             0.000000
  0. 5hXQ/W6ysNRX0SMN+pC2lpTX/g65PPbr  active   -                      -                 0.000001       -             0.000000
 C1. -                                 -        127.0.0.1:49546        5824/37888        0.000001       -             0.000000
  1. cJiFXHw1lencbStkwqw+3LYzK47dPPzz  active   -                      -                 36.529854      -             2.978842
 C1. -                                 -        127.0.0.1:49611        27072/37184       36.529854      -             2.978842
  2. ZO03FGsAsWfTroIQiH3hbOhrSGDENlM6  archive  -                      -                 279.506721     -             17.102375
  3. IKuQxQzxVme/TMyTngjl2/mmZbeTPjEs  active   -                      -                 3367.156759    -             281.829663
 C1. -                                 -        127.0.0.1:51299        2720/2912         35.493823      -             3.200133
 C2. -                                 -        127.0.0.1:51354        1376/2816         3367.156759    Jonano1       281.829663
-----------------------------------------------------------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------------------
    ...
    output: EL5Nfmve021QCBB0yyLS69QdKwV9xH3r           0.000000000
    output: t3sOkNEKp3TwQXEeThSxAWDFymAqJELs           0.000000000
    output: ElecK6xIzLcVK8qYmDuOALOXl2SFx1N9           0.000000000
...
-------------------------------------------------------------------------------------------
   earning: QHul3aEvYN8KHkArCW7xOw1i5uLLGRzN        1024.000000000  2018-05-26 19:34:23.999
    ...
    output: AKoaDXKGUjoJKlNK2iP3CltkdKYfhUp7           2.118406890  2018-05-26 19:49:20.390
    output: crqPIxsR7TAq1PMpahTDwImUUlnMIAJ1           2.106789894  2018-05-26 19:49:20.393
    output: UTgjTbGi9kA9i30A7hml4Oqyw8W62AoG           3.436523429  2018-05-26 19:49:20.395
    output: FbM4lXZ9SbV8+QtRfhfl/Pj+YpfYVnPO           1.371980242  2018-05-26 19:49:20.398
    output: U8I3EnAdmwSi88Izl3MVqExVFmqvVDLE           3.222378291  2018-05-26 19:49:20.401
    output: aBxFYbuRwakAk37/4lDtauxRmQuIpfXz           2.402931114  2018-05-26 19:49:20.404
...
' . $separator . '
    ...
    output: uLoCvMVq0O2a7sgDMyQvKMGaRHOXIz++           0.512125867
    output: C1WJo2aAT+EArTzXU6Toh0WWDu8HeYYF           0.010335008
    output: eSMifUuXKU+dv1haXEaxXfkjOE2OtERA           0.505720042
    output: eSMifUuXKU+dv1haXEaxXfkjOE2OtERA           0.323766055
    output: rhfwlcohFLedkvtrjYkHt3SRFJCvBXTN           0.170672174
    output: agMKx/B0ushvlBlvFsEA+/a7bSLAq04T           0.631765812
    output: V3nPVIzCHcKWzu21FD5wEJsqF8OpApyw           0.154111059
